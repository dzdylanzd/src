...
namespace Model
{
	...
	{
		Application::Logger::log(Application::MainApplication::getArg("-robot").value);
		Application::Logger::log(Application::MainApplication::getArg("-pattern").value);
		PopulatePattern populater(std::stoul(Application::MainApplication::getArg("-robot").value));
		populater.populate(std::stoul(Application::MainApplication::getArg("-pattern").value));
